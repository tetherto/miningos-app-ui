export const COLOR = {
  ...
  COLD_ORANGE_ALPHA_01: '#f7931a1a',
  COLD_ORANGE_ALPHA_04: '#F7931A4D',
  ORANGE_HOVER: '#c4730f',
  ...
  GREEN: '#72F59E',
  GREEN_ALPHA_01: 'rgba(114, 245, 158, 0.1)',
  DARK_GREEN: '#18251c',
  LIGHT_GREEN: '#52C41A',
  GRASS_GREEN: '#34C759',
  EMERALD: '#009393',
  ...
  ORANGE_WARNING_ALPHA_01: 'rgba(245, 158, 11, 0.1)',
  ...
  MEDIUM_BLUE: '#4289C1',
  SLEEP_BLUE: '#3B82F6',
  SLEEP_BLUE_ALPHA_01: 'rgba(59, 130, 246, 0.1)',
  INDIGO: '#5B5FFB',
  MINT_GREEN: '#6EE7B7',
  POOL: '#00D0D8',
  OCEAN_GREEN: '#3AFFF2',
  ...
  BRIGHT_GREEN: '#72F69E',
  GREY_IDLE: '#6B7280',
  GREY_IDLE_ALPHA_01: 'rgba(107, 114, 128, 0.1)',
  ...
  DARK_GRAY: '#1A1A1A',
  MEDIUM_GRAY: '#2A2A2A',
  LIGHT_DARK_GRAY: '#3A3A3A',
  TEXT_GRAY: '#808080',
  LABEL_GRAY: '#B0B0B0',
  DARK_ORANGE_BG: '#3B2B20',
  ORANGE_DARK_BG: '#1A1410',
