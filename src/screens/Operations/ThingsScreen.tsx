...
export const ThingsScreen: React.FC = () => {
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
      <Text style={styles.title}>Devices</Text>
      <Card title="Device List" style={styles.card}>
        <Text style={styles.placeholder}>Device list will be displayed here</Text>
      </Card>
    </ScrollView>
  );
};
