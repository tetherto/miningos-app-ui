...
export const HistoricalMovementsScreen: React.FC = () => (
  <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
    <Text style={styles.title}>Historical Movements</Text>
    <Card title="Movement History" style={styles.card}>
      <Text style={styles.placeholder}>Historical movements list</Text>
    </Card>
  </ScrollView>
);
