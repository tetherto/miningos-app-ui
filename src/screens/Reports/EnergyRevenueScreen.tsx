...
export const EnergyRevenueScreen: React.FC = () => (
  <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
    <Text style={styles.title}>Energy Revenue</Text>
    <Card title="Energy Revenue Analysis" style={styles.card}>
      <Text style={styles.placeholder}>Energy revenue content</Text>
    </Card>
  </ScrollView>
);
