...
export const EBITDAScreen: React.FC = () => (
  <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
    <Text style={styles.title}>EBITDA</Text>
    <Card title="EBITDA Analysis" style={styles.card}>
      <Text style={styles.placeholder}>EBITDA content</Text>
    </Card>
  </ScrollView>
);
