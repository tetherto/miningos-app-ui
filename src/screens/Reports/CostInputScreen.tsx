...
export const CostInputScreen: React.FC = () => (
  <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
    <Text style={styles.title}>Cost Input</Text>
    <Card title="Cost Input Analysis" style={styles.card}>
      <Text style={styles.placeholder}>Cost input content</Text>
    </Card>
  </ScrollView>
);
