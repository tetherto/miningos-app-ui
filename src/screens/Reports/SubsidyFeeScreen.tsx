...
export const SubsidyFeeScreen: React.FC = () => (
  <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
    <Text style={styles.title}>Subsidy Fee</Text>
    <Card title="Subsidy Fee Analysis" style={styles.card}>
      <Text style={styles.placeholder}>Subsidy fee content</Text>
    </Card>
  </ScrollView>
);
