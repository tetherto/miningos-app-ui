...
export const HashBalanceScreen: React.FC = () => (
  <ScrollView style={styles.container} contentContainerStyle={styles.scrollContent}>
    <Text style={styles.title}>Hash Balance</Text>
    <Card title="Hash Balance Analysis" style={styles.card}>
      <Text style={styles.placeholder}>Hash balance content</Text>
    </Card>
  </ScrollView>
);
