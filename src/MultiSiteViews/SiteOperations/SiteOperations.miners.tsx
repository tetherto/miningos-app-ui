...
const SiteOperationsMiners = () => {
  ...
  const minersData = (responseData as { data?: unknown[] | { [key: string]: unknown; dataset?: unknown[]; log?: unknown[] } } | undefined)?.data
      ...
      charts={[
        {
          ...
          nominalValue: chartConfig.nominalKey ? (minersData as Record<string, unknown> | undefined)?.[chartConfig.nominalKey] as number | undefined : undefined,
