...
describe('processRevenueDatasetWith1MThreshold', () => {
  ...
  it('should use BTC when average per label is above 1 BTC', () => {
    ...
    expect(result.dataset[0]['2025-10-01'].value).toBe(1.5)
    expect(result.dataset[1]['2025-10-01'].value).toBe(0.8)
  })
  ...
  it('should use SATS and multiply values by 1,000,000 when average per label is below 1 BTC', () => {
    ...
    expect(result.dataset[0]['2025-10-01'].value).toBe(1500000) // 1.5 * 1,000,000
    expect(result.dataset[0]['2025-10-02'].value).toBe(300000) // 0.3 * 1,000,000
    expect(result.dataset[1]['2025-10-01'].value).toBe(400000) // 0.4 * 1,000,000
    expect(result.dataset[1]['2025-10-02'].value).toBe(200000) // 0.2 * 1,000,000
    // Style should be preserved
    expect(result.dataset[0]['2025-10-01'].style).toEqual({
  ...
  it('should use SATS when average per label equals exactly 1 BTC', () => {
    ...
    expect(result.currencyUnit).toBe(CURRENCY.SATS)
    expect(result.dataset[0]['2025-10-01'].value).toBe(1000000) // 1.0 * 1,000,000
    expect(result.dataset[1]['2025-10-01'].value).toBe(1000000) // 1.0 * 1,000,000
  })
  ...
  it('should handle datasets with different date keys across labels', () => {
    ...
    expect(result.dataset[0]['2025-10-01'].value).toBe(500000)
    expect(result.dataset[0]['2025-10-02'].value).toBe(300000)
    expect(result.dataset[1]['2025-10-01'].value).toBe(400000)
  })
  ...
  it('should handle edge case with very small values', () => {
    ...
    expect(result.currencyUnit).toBe(CURRENCY.SATS)
    expect(result.dataset[0]['2025-10-01'].value).toBe(1) // 0.000001 * 1,000,000 = 1
  })
  ...
  it('should handle edge case with zero values', () => {
    ...
    expect(result.currencyUnit).toBe(CURRENCY.SATS)
    expect(result.dataset[0]['2025-10-01'].value).toBe(0) // 0 * 1,000,000 = 0
  })
})
